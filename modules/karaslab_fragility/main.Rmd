...
#### Step 4: Find Electrodes Above Fragility Threshold

```{rave find_threshold_elec, language = "R", export = "threshold_elec"}
threshold_elec <- threshold_fragility(
  repository = repository,
  adj_frag_info = adj_frag_info,
  t_step = t_step,
